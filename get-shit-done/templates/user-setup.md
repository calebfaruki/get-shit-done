...
Template for `.planning/project/PHASE-{N}-USER-SETUP.md` - human-required configuration that Claude cannot automate.
...
**Timing:** Generated by the executor after tasks complete, before PROJECT-SUMMARY.md update.
